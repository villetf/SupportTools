...
if (!(Test-Path "C:\Program Files\PowerShell\7\pwsh.exe")) {
   Write-Host "SupportTools kräver Powershell 7, som inte är installerat. Installera det genom Klientsystem och kör detta skript igen. Går till Klientsystem..." -ForegroundColor Red
   Start-Sleep -Seconds 5
   Start-Process "https://clientsystem.domain.se/Klienhanteringssystem/Application/InstallForClients#targetName=$env:computername"
   exit
}
...
if ((Get-ExecutionPolicy) -eq "Restricted") {
   ...
   Start-Process "https://servicedesk.domain.se/ui/solutions?entity_id=124&mode=detail#feedback"
}
